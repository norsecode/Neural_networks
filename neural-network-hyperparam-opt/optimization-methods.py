...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(L):
        ...
        s["dW" + str(l+1)] = (s["dW" + str(l+1)] * beta2) + np.multiply(1-beta2, np.square(grads['dW' + str(l+1)]))
        s["db" + str(l+1)] = (s["db" + str(l+1)] * beta2) + np.multiply(1-beta2, np.square(grads['db' + str(l+1)]))
...
# train 3-layer model with momentum optimization
print("Training with momentum optimization")
layers_dims = [train_X.shape[0], 5, 2, 1]
...
# train 3-layer model with adam optimization
print("Training with adam optimization")
layers_dims = [train_X.shape[0], 5, 2, 1]
